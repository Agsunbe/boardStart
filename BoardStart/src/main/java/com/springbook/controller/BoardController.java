...
import com.springbook.domain.Page;
...
public class BoardController{
	...
	List<BoardVO> list = null;
	list = service.listPage(page.getDisplayPost(), page.getPageNum());
	
	model.addAttribute("list", list);   
	model.addAttribute("pageNum", page.getEndPageNum());
	
	model.addAttribute("startPageNum", page.getEndPageNum());
	...
	List<BoardVO> list = null;
	list = service.listPageSearch(page.getDisplayPost(), page.getPageNum());
